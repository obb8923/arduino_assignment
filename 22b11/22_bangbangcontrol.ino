...
#define _DUTY_MAX 1640 // 2000
#define _DUTY_NEU 1230 // 1500
#define _DUTY_MIN 1040 // 1000

#define _SERVO_ANGLE_DIFF  48  // Replace with |D - E| degree
#define _SERVO_SPEED       340  // servo speed
...
float volt_to_distance(int a_value)
{
  ...
  // return (6762.0 / (a_value - 9) - 4.0) * 10.0; 
      return 509 + (-1.56)*a_value + 0.00119 * a_value * a_value;
